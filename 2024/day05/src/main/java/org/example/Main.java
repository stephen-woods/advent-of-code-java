...
// notation X|Y means that if both page number X and page number Y are to be produced as part of an update, page number
...
public class Main {
    public static void main(String[] args) throws IOException {
        System.out.println("What do you get if you add up the middle page number from those correctly-ordered updates?");
    ...
    public static int partA() throws IOException {
        var answer = 0;

        Rules rules;
        try (var is = ClassLoader.getSystemResourceAsStream("sample_a.txt");
    ...
    public static int partB() throws IOException {
        return 0;
    }
}